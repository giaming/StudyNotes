...
Redis 之所以能知道那些键值过期，是因为在 Redis 中维护了一个字典，存储了所有设置了过期时间的键值，我们称之为==过期字典==。

过期键判断流程如下图所示：

![内存过期策略-过期键判断流程.png](images/3bf71ae0-5de7-11ea-9e57-957b6467a3fc.png)
...
![微信截图_20191116185218.png](images/4f62e050-5de7-11ea-97d6-db1217470ff3.png)
...
![内存过期策略-惰性删除执行流程.png](images/a5e135d0-5de7-11ea-8972-8fbbcd885f6f.png)
...
![内存过期策略-执行流程2.png](images/c511d450-5de7-11ea-a9fa-c1c510366b3a.png)
